...
class Crawler {
  ...
  async _scrape() {
    ...
    if (
      ...
      && this._options.exposeFunctionsNames
      && Array.isArray(this._options.exposeFunctions)
      && Array.isArray(this._options.exposeFunctionsNames)
      && this._options.exposeFunctions.length
        === this._options.exposeFunctionsNames.length
    ) {
      await Promise.all(
        this._options.exposeFunctionsNames.map((name, i) => this._page.exposeFunction(
          name,
          this._options.exposeFunctions[i],
        )),
      );
    }
