...
class Crawler {
  ...
  async _scrape() {
    ...
    if (this._options.exposeFunctions && this._options.exposeFunctionsNames &&
      Array.isArray(this._options.exposeFunctions) && Array.isArray(this._options.exposeFunctionsNames) &&
      this._options.exposeFunctions.length === this._options.exposeFunctionsNames.length) {
      this._options.exposeFunctionsNames.forEach(async (name, i) => {
